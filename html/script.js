document.addEventListener("DOMContentLoaded", (event) => {
    var ProgressBar = {
        ...
        update: function (data) {
            ...
            this.progressContainer.style.transition = "opacity 0.3s ease-in";  // Add a transition effect
            this.progressContainer.style.opacity = "100";  // Set opacity to 0 to create a fade-out effect
        ...
        cancel: function () {
            ...
            this.progressContainer.style.transition = "opacity 0.3s ease-out";  // Add a transition effect
            this.progressContainer.style.opacity = "0";  // Set opacity to 0 to create a fade-out effect
